...
//  // shows the amount and the receiver accout
...
//      }
   ...
   const receiverPerson = accounts.find( (acc)=> acc.username === inputTransferTo.value); 
...
const changePinFunction = function(acc){     
 ...
 function changePin() { 
   ...
   if(currentAccount.pin === Number(inputOldPin.value)  ){
        ...
        console.log('current PIN number of the ownder ' + currentAccount.pin);
